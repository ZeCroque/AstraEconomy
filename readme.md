...
- 3x 2-Stars legendary (2 Astras)
- 3x 4-Stars legendary (4 Astras)
- 1x 2-Stars legendary + 1x 1-Star legendary (1 Astra)
- 1x 4-Stars legendary + 1x 2-Stars legendary (2 Astras)
- 1x 4-Stars legendary + 2x 1-Star legendary (2 Astras)

If the "star level" of the items you gave is not divisible by 3, you will be given back the surplus.

### Buying X-Tech

The amount of X-Tech you will receive is settable in the Gameplay Options. There's a list of available settings:
- Very Expensive: You will get 1 X-Tech for 5 Astras.
- Expensive: You will get 1 X-Tech for 3 Astras.
- Even: You will get 1 X-Tech for 1 Astra.
- Cheap: You will get 2 X-Techs for 1 Astra. [Default]
- Very Cheap: You will get 3 X-Techs for 1 Astra.
...
This mod is made of seven files : 
- *AstraEconomy.esm*
...
You can find the source code here : https://github.com/ZeCroque/AstraEconomy
